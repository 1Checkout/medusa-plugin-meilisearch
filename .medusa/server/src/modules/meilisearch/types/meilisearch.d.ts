...
export type Transformer<Result = any> = (document: any, defaultTransformer: DefaultTransformer, options?: TransformOptions) => Result;
export type DefaultProductTransformer<Result extends TransformedProduct = TransformedProduct> = (document: ProductDTO, options?: TransformOptions) => Result;
export type ProductTransformer<Result extends TransformedProduct = TransformedProduct> = (document: ProductDTO, defaultTransformer: DefaultProductTransformer, options?: TransformOptions) => Promise<Result>;
export type DefaultCategoryTransformer<Result extends TransformedCategory = TransformedCategory> = (document: ProductCategoryDTO, options?: TransformOptions) => Result;
export type CategoryTransformer<Result extends TransformedCategory = TransformedCategory> = (document: ProductCategoryDTO, defaultTransformer: DefaultCategoryTransformer, options?: TransformOptions) => Promise<Result>;
/**
